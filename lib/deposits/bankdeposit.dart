...
class _BankDepositState extends State<BankDeposit> {
  ...
  Future<void> fetchCustomerAccounts() async {
    final agentUrl =
        "https://fnetghana.xyz/get_customer_account/${_customerController.text}/";
  ...
  Future<void> fetchCustomerBankAndNames(String deBank) async {
    try {
      final customerAccountUrl =
          "https://fnetghana.xyz/get_customer_accounts_by_bank/${_customerController.text}/$deBank";
  ...
  processDeposit() async {
    ...
    if (res.statusCode == 201) {
      ...
      if (accountNumbers.contains(_currentAccountNumberSelected) &&
          _currentSelectedBank == "Fidelity Bank") {
        processAddPoints(0);
      }
      if (!accountNumbers.contains(_currentAccountNumberSelected) &&
          _currentSelectedBank == "Fidelity Bank") {
      ...
      if (!accountNumbers.contains(_currentAccountNumberSelected) &&
          interBanks.contains(_currentSelectedBank)) {
        processAddPoints(2);
      }
