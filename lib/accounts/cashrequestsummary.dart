...
import 'package:fnet_new/views/usercashrequestdetail.dart';
...
class CashRequestSummary extends StatefulWidget {
  ...
  @override
  _CashRequestSummaryState createState() => _CashRequestSummaryState();
}

class _CashRequestSummaryState extends State<CashRequestSummary> {

  late String username = "";
  final storage = GetStorage();
  bool hasToken = false;
  late String uToken = "";
  late List allCashRequest = [];
  var items;
  bool isLoading = true;
  late List amounts = [];
  ...
  fetchAllCashRequest()async{
    ...
    if(response.statusCode ==200){
      ...
      allCashRequest = json.decode(jsonData);
      amounts = allCashRequest;
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context){
                      return UserCashRequestsDetail(req_date:requestDates[i]);
                    }));
                  },
                  child: Padding(
