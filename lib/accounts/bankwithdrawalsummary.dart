...
class BankWithdrawalSummary extends StatefulWidget {
  ...
  @override
  _BankWithdrawalSummaryState createState() => _BankWithdrawalSummaryState();
}
...
class _BankWithdrawalSummaryState extends State<BankWithdrawalSummary> {
  ...
  fetchAllCustomersBankRequest()async{
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context){
                      return UserBankWithdrawalDetail(req_date:requestDates[i]);
                    }));
                  },
                  child: Padding(
                          ...
                          title: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(items.toString().split("T").first,style: const TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.white),),
                              ],
                            ),
                          ),
                        ),
