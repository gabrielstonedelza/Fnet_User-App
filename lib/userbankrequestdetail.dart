...
class UserBankRequestsDetail extends StatefulWidget {
  final req_date;
  const UserBankRequestsDetail({Key? key,this.req_date}) : super(key: key);

  @override
  _UserBankRequestsDetailState createState() => _UserBankRequestsDetailState(req_date: this.req_date);
}

class _UserBankRequestsDetailState extends State<UserBankRequestsDetail> {
  final req_date;
  _UserBankRequestsDetailState({required this.req_date});
