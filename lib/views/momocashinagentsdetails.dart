...
class MomoCashInAgentsDetails extends StatefulWidget {
  final date_deposited;
  final agentCashIn;
  const MomoCashInAgentsDetails({Key? key,required this.date_deposited,required this.agentCashIn}) : super(key: key);

  @override
  State<MomoCashInAgentsDetails> createState() => _MomoCashInAgentsDetailsState(date_deposited:this.date_deposited,agentCashIn:this.agentCashIn);
}

class _MomoCashInAgentsDetailsState extends State<MomoCashInAgentsDetails> {
  final date_deposited;
  final agentCashIn;
  _MomoCashInAgentsDetailsState({required this.date_deposited,required this.agentCashIn});
