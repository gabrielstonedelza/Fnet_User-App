...
class _MakeCashPaymentState extends State<MakeCashPayment> {
  ...
  payCashRequest()async{
    final requestUrl = "https://fnetghana.xyz/approve_cash_request_paid/$id/";
  ...
  processCashPayment(context) async {
    const registerUrl = "https://fnetghana.xyz/make_cash_payments/";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Make cash payment"),
      ),
      body: ListView(
        children: [
